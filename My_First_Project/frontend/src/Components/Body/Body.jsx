...
import BUFF from "./Steam Momo.png";
const Body = () => {
  return (
    <>
      <div className="w-[1440px] h-full flex flex-col gap-10">
        <section className="relative w-full overflow-hidden h-[726px] px-28 flex items-center justify-between gap-5">
          <div className="h-[840px] w-[840px] absolute bg-orange-600 rounded-full left-[970px] bottom-0 -z-10"></div>
          <div className="flex flex-col gap-4">
            ...
            <div>
              <h1 className="text-xl text-semibold">
                More Than
                <span className="text-2xl text-bold text-orange-600">
                  20+ Varieties
                </span>
            ...
            <div className="flex items-center">
              <Button
                ...
                className="bg-[#0C6967] py-5 px-10 rounded-full text-white flex items-center gap-2 text-xl my-4"
                icon={<FaArrowRightLong />}
              />
            </div>
          </div>
          <div className="w-[176px] h-[152px] gap-4 flex-wrap flex absolute top-40 right-[553px]">
          ...
          <div className="w-[176px] h-[152px] gap-4 flex-wrap flex absolute bottom-[70px] right-10">
          ...
          <div className="ralative w-[622px] h-[434px]">
            <img
              src={MOMO}
              alt="MOMO"
              className=" absolute top-[195px] left-[743px] outline-none border-none text-center"
            />
          </div>
        </section>
        <section className="w-[1440px] h-[726px] flex items-center px-28 justify-between">
          <div className="relative w-[490px] h-[598px]">
            ...
            <div>
              <img
                src={PERSON}
                alt="img"
                className="absolute z-10 -top-[20px] left-[30px] h-[598px] w-[400px]"
              />
            </div>
            <div></div>
          </div>
        ...
        <section className="w-[1440px] h-[834px] flex items-center justify-center flex-col gap-16 px-28">
          ...
          <div className="flex gap-6">
            ...
            />
            <Button
              className="border-2 py-3 px-12 border-slate-200 duration-300 rounded-full hover:border-2 hover:border-slate-900"
              text="Chicken"
            />
            <Button
              className="border-2 py-3 px-12 border-slate-200 rounded-full duration-300 hover:border-2 hover:border-slate-900"
              text="Veg"
            />
          </div>
            ...
            <div className="flex gap-11 static w-[952px] h-[323px]">
              <div className="h-[323px] w-[288px] flex flex-col items-center justify-center rounded-sm ">
                <img
                  src={BUFF}
                  alt="buff momo"
                  className="w-[288px] h-[256x]"
                />
                <div className=" text-center font-bold text-slate-900">
                  <h1 className="text-2xl">Buff Momo</h1>
                  <p className="flex items-center justify-center h-9 text-2xl">
                    <img src={Ru} alt="Ru" className="h-4 w-4 mt-1" />{" "}
                    <span className="text-orange-600">150</span>
                  </p>
                </div>
              </div>
              <div className="h-[323px] w-[288px] flex flex-col items-center justify-center rounded-sm ">
                <img src={FRY} alt="buff momo" className="w-[288px] h-[256x]" />
                <div className=" text-center font-bold text-slate-900">
                  <h1 className="text-2xl">Buff Fry Momo</h1>
                  <p className="flex items-center justify-center h-9 text-2xl">
                    <img src={Ru} alt="Ru" className="h-4 w-4 mt-1" />{" "}
                    <span className="text-orange-600">180</span>
                  </p>
                </div>
              </div>
              <div className="h-[323px] w-[288px] flex flex-col items-center justify-center rounded-sm ">
                ...
                />
                <div className=" text-center font-bold text-slate-900">
                  <h1 className="text-2xl">Buff C.Momo</h1>
                  <p className="flex items-center justify-center h-9 text-2xl">
                    <img src={Ru} alt="Ru" className="h-4 w-4 mt-1" />{" "}
        ...
        <section className="w-[1440px] h-[1368px] bg-slate-50">
          <div className="flex items-center justify-center px-28">
            <h1 className="text-4xl font-bold py-20">
              <span className="text-orange-600">We Offer People </span>The
              Service They Want
            </h1>
          </div>
          <div className="bg-[url('/Images/Image.png')] h-[640px]">
            <div className="px-28 bg-gradient-to-t from-slate-900 to-transparent h-[640px] flex items-center gap-16 justify-center flex-col">
              <div className="flex items-center justify-center text-center flex-col font-semibold">
              ...
              <div>
                <Button
                  ...
                  className=" flex items-center justify-center gap-6 px-12 py-5 bg-[#0C6967] text-xl text-white rounded-full"
                  text="Watch The Video"
                />
              </div>
            </div>
          </div>
          <div className="px-28 py-16 flex flex-col items-center justify-center gap-10">
            ...
            <div className="w-[461px] bg-[#0C6967] h-[807px] rounded-3xl text-white px-8 py-16 gap-16 flex flex-col">
              ...
              <div className="gap-6 flex flex-col">
                ...
                <div className="flex items-start gap-14">
                  <div className="flex flex-col gap-3 text-2xl italic">
                    <h1>Mobile</h1>
                    <h1>980 5689789</h1>
                    <h1>9841 275897</h1>
                  </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-14">
                  <div className="flex flex-col text-2xl">
                    ...
                    <h3 className="italic">10 am - 8 pm</h3>
                  </div>
                  <div className="flex flex-col text-2xl">
                    <h1 className="font-bold">SAT - SUN</h1>
                    <h3 className="italic">Closed</h3>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-6">
